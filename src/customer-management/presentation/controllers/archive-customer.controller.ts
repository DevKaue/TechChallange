...
export default class ArchiveCustomerController
  implements Controller<ArchiveCustomerRequest, undefined>
{
  constructor(private readonly archiveCustomerUseCase: ArchiveCustomerUseCase) {}
